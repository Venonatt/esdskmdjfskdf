...
const devs = ['388357326614167563','451828723017056268'];
var prefix = "!";
const adminprefix = "!"
...
setURL('https://discordapp.com/oauth2/authorize?client_id=483962495124504576&permissions=2080898225&scope=bot')
.setAuthor(client.user.username,client.user.avatarURL)
...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/oauth2/authorize?client_id=48396249512450457&permissions=2080898225&scope=bot`)
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/hbQTcb9**")
